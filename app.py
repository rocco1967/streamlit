...
Gender = st.number_input('Gender:', min_value=0.0, max_value=1.0,value=12.0)
Age = st.number_input('Age:', min_value=12.0,max_value=80.0,value=1.0)
Height = st.number_input('Height:', min_value=120.0,max_value=210.0,value=1.0)
Weight = st.number_input('Weight:', min_value=35.0,max_value=160.0,value=1.0)
Duration = st.number_input('Duration:', min_value=1.0, max_value=240.0, value=1.0)
Heart_Rate = st.number_input('Heart_Rate:', min_value=50.0,max_value=230.0,value=1.0)
Body_Temp = st.number_input('Body_Temp:', min_value=35.0,max_value=41.0,value=1.0)
