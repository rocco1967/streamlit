...
Weight = st.number_input('Weight:', min_value=35.0,max_value=160.0,value=35.0,step=1.00)
st.write('inserisci durata esercizio(corsa ecc ecc) in minuti')         
Duration = st.number_input('Duration:', min_value=10.0, max_value=240.0, value=1.0,step=1.00)
